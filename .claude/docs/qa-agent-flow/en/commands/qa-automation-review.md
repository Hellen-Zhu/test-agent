...
Design a Java + Cucumber API + E2E hybrid automation implementation and perform a quality review.

## Usage

```text
/qa-automation-review <BDD And Case Design + Test Strategy + existing framework constraints>
```
